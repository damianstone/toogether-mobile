...
export declare function setOfflineComponentProvider(firestore: FirebaseFirestore, persistenceSettings: PersistenceSettings, offlineComponentProvider: OfflineComponentProvider): Promise<void>;
