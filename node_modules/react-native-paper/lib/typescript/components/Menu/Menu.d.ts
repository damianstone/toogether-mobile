...
declare class Menu extends React.Component<Props, State> {
    static Item: React.ComponentType<Pick<import("./MenuItem").Props, "style" | "title" | "onPress" | "testID" | "accessibilityLabel" | "icon" | "disabled" | "titleStyle" | "contentStyle"> & {
        ...
        ({ icon, title, disabled, onPress, style, contentStyle, testID, titleStyle, accessibilityLabel, theme, }: import("./MenuItem").Props): JSX.Element;
        displayName: string;
    }, {}>;
    static defaultProps: {
        statusBarHeight: any;
